...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png',460,420,30,30,1),
    new Obstaculo('imagenes/bache.png', 250,370,30,30,1),
    new Obstaculo('imagenes/bache.png', 500,130,30,30,1),
    // Autos verdes
    new Obstaculo('imagenes/auto_verde_derecha.png',770,455,30,15,1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 350,390,15,30,1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 450,450,15,30,1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 400,200,15,30,1),
    new Obstaculo('imagenes/auto_verde_derecha.png',800,470,30,15,1)
  ],
  ...
  enemigos: [
    ...
    new ZombieCaminante('imagenes/zombie1.png', 380, 155, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png', 80, 355, 10, 10, 2, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 80, 455, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 10, { //vertical1
      desdeX: 0,
      hastaX: 961,
      desdeY:-20,
      hastaY: 600,
    }, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 8, { //vertical2
      desdeX: 0,
      hastaX: 961,
      desdeY: -15,
      hastaY: 600
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    /* COMPLETAR */
    Jugador.mover = function(x,y){ //ancho y alto=que su objeto
      if(x>0){   // 0 es hacer ningun movimiento .
...
Juego.dibujar = function() {
  ...
  this.dibujarFondo();
  //Dibujante.dibujarImagen('imagenes/llegada.jpg',760, 535, 130,30);
...
Juego.calcularAtaques = function() {
  this.enemigos.forEach(function(enemigo) {
    if (this.intersecan(enemigo, this.jugador, this.jugador.x, this.jugador.y)) {
      ...
      COMPLETAR */
      Enemigo.prototype.comenzarAtaque(this.jugador);
    } else {
...
Juego.dibujarFondo = function() {
  ...
  // Si se gano el juego hay que mostrar el mensaje de ganoJuego de fondo
    ...
    Dibujante.dibujarImagen('imagenes/logo.png', 190, 113, 500, 203);
    document.getElementById('reiniciar').style.visibility = 'visible';
  } else {
